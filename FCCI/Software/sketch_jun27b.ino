...
void loop() {
 ...
 /*  Serial.print(channel_1_rud,DEC);
   Serial.print(" "); 
   Serial.print(channel_2_thr,DEC);   
   Serial.print(" "); 
   Serial.print(channel_3_ele,DEC);   
   Serial.print(" "); 
   Serial.print(channel_4_ail,DEC);   
   Serial.print(" "); 
   Serial.print(channel_5_tbd,DEC); 
   Serial.print(" "); 
   Serial.print(channel_6_mode,DEC); 
   Serial.print("\n"); */
//   
//   delay(1000);
...
switch(state){
 ...
 case 3:
   ...
   state=0;
   Serial.println(serial_rx_1_rud,DEC); 
   Serial.println(serial_rx_2_thr,DEC); 
   Serial.println(serial_rx_3_ele,DEC); 
